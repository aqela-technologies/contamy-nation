...
import MintButtonTexture from "./assets/images/design-elements/mint-button.png";
...
export const MultiMintButton = ({
    ...
    const classNameValue = useMemo(()=>getMintButtonContent(),[isSoldOut,isMinting])
