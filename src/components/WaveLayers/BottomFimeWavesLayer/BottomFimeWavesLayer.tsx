export default function BottomFimeWavesLayer() {
  return (
    <div className="relative flex-1">
      ...
      <div className="absolute w-full h-full z-wave-three bg-wave-four-color" />
      <div className="absolute w-full h-full z-wave-three bg-wave-five-color" />
    </div>
  );
}
